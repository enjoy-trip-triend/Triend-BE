...
public class MemberServiceImpl implements MemberService {
    ...
    public void createMember(Member member) {
        ...
        if (Objects.nonNull(member.getCharacters()) && !member.getCharacters()
                .isEmpty()) {
    ...
    @Override
    public List<String> getCharactersNameByMemberId(Long memberId) {
        List<CharacterDTO> characterDTOS = memberMapper.selectCharactersById(memberId);
