...
public class RecommendationServiceImpl implements RecommendationService {
	...
	@Override
	public List<RecommendationPlaceResponseDto> recommendPlacesByMbti(Member me, int limit) {
		return myPlaceMapper.selectTopPlacesByMbti(me.getMbti(), me.getId(), limit);
	}

	@Override
	public List<RecommendationPlaceResponseDto> recommendByCharacters(Member me, int limit) {
	...
	@Override
	public List<RecommendationPlaceResponseDto> recommendCombined(Member me, int limit) {
