...
public class PlannerWebSocketController {
    ...
    public void joinPlanner(JoinGroupMessage joinMessage, SimpMessageHeaderAccessor headerAccessor) throws UnknownHostException {
        String sessionId = headerAccessor.getSessionId();
        String ipAddr = InetAddress.getLocalHost().getHostAddress();
        plannerWebSocketService.joinEditor(joinMessage, sessionId, ipAddr);
    }
