...
import com.ssafy.websocket.handler.CustomHandshakeHandler;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    /**
     * /gs-guide-websocket endpoint를 등록하는 메서드로, WebSocket을 못쓸때 SockJS를 fallback option으로 쓸 수 있게 한다.
     *
     * @param registry StompEndpointRegistry
     */
    @Override
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/triend-websocket")
