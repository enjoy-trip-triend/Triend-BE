...
INSERT INTO boards (title, content, member_id) VALUES
('제주도 여행 후기', '성산일출봉 진짜 최고였어요!', 1),
('부산 먹방 꿀팁', '자갈치시장+해운대 코스 강추', 2),
('서울 궁궐 탐방기', '경복궁에서 한복 입고 사진 찍음!', 3),
('강릉 힐링 추천', '경포대에서 멍때리기 최고', 4),
('전주 한옥마을', '한옥 마을 진짜 예뻐요', 5);
